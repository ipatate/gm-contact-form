<script type="text/javascript">
  var gmContactFormSuccessMessage = '<?php echo addslashes(__("The message was sent successfully.Thank you ", "gm-contact-form"));  ?> ';
  var gmContactFormErrorMessage = '<?php echo addslashes(__("Oh! An error occurred while processing your request😱", "gm-contact-form"));  ?> ';
</script>
